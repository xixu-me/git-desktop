...
> {
  ...
  public render() {
    return (
      <Dialog
        title="Move Git Desktop to the Applications folder?"
      ...
      >
        <DialogContent>
          <p>
            We've detected that you're not running Git Desktop from the
    ...
    return (
      <DialogFooter>
        <OkCancelButtonGroup
          ...
          okButtonTitle="This will move Git Desktop to the Applications folder in your machine and restart the app."
